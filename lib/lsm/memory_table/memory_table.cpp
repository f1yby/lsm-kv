...
namespace kvs {
  ...
  SSTableNodePool::SSTableNodePool(uint64_t id, uint32_t dump_limit) : _id(id), dump(dump_limit), data_size(0), _filter(10240 / 2, key_size_max) {
    data_size += 32;// header size
    data_size += 10240;
  }
